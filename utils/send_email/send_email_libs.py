...
from_email = "wedding@wulilove.cn"            #发送的邮箱
...
if __name__ == "__main__":
    #发送邮箱的内容
    content = """您好，wulilove.cn网站提醒您，您正在进行找回密码操作,修改密码请点击<a href="http://192.168.223.129:9000/"></a>"""
    #收件人邮箱地址
    to_email = ["likui0428@sina.com"]
    ...
    # 测试发送html邮件
    send_fail = send_qq_html_email(from_email, to_email, "wulilove", content)
    # 测试发送带附件邮件
